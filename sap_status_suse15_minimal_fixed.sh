#!/usr/bin/env bash
# sap_status_suse15_minimal_fixed.sh
# Purpose: Minimal SAP status check for SUSE 15
# Outputs: Hostname, SID, Nr, Running (Yes/No)
# Supports: Clustered HANA, ENSA2 ASCS/ERS clusters, standalone HANA, standalone ASCS/ERS, APP servers
...
# Cluster detection with ENSA2 handling
if [[ -n "$CRM_OUT" ]]; then
